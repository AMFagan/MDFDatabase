...
class MDF:
	...
	delivery = {'lectures' : None, 'tutorial': None, 'assignments' : None, 'laboratories' : None, 'private study' : None, 'total': None} 
	aims = ''
	learning_outcomes = ''
	syllabus = ''
	assessment = None
	...
	def __init__(self, tup):
		...
		self.pre_requisites['other'] += ([] if tup[8] == None else [tup[8]])
